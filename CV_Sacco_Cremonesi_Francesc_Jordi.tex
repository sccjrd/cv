...
\author{Stefano Taillefert} % github.com/Steeven9
...
\marginnote{
	...
	21 August 2003\\
	\vspace{0.5cm}
	\href{tel:+41797424928}{+41 79 742 49 28}\\
	\vspace{0.5cm}
	\href{mailto:francescjordicremonesi@duck.com}{francescjordicremonesi\\@duck.com}\\
	% \vspace{0.5cm}
	% \href{https://github.com/Steeven9}{github.com/Steeven9}\\
}
...
\begin{table}[H]
	\begin{tabular}{ll}
		...
		% & Optional subjects: Informatics, Robotics
	\end{tabular}
\end{table}
\vspace{-0.5cm}
...
\begin{table}[H]
	\begin{tabular}{ll}
        ...
        \\
		\textbf{Educator and} & March 2023 - today\\
...
\begin{table}[H]
	\begin{tabular}{ll}
		...
		\\
		\textbf{Build tools} & GitLab\\
		\\
		\textbf{Other softwares} & Git, Bitbucket, MSSQL, MongoDB\\
		% \\
...
% \begin{table}[H]
% 	\begin{tabular}{lll}
% 		% Christoph Schnyder, Swisscom, \href{mailto:christoph.schnyder@swisscom.com}{christoph.schnyder@swisscom.com}\\
% 		% \\
% 		% Mauro Prevostini, USI, \href{mailto:mauro.prevostini@usi.ch}{mauro.prevostini@usi.ch}\\
% 		% \\
% 		% Vasco Piffaretti, EOC, \href{mailto:vasco.piffaretti@eoc.ch}{vasco.piffaretti@eoc.ch}\\
% 	\end{tabular}
% \end{table}
